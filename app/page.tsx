      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 whitespace-nowrap">
              유지보수성과 확장성, 비용 효율성을 균형 있게 고려하는 백엔드
              개발자입니다.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                쿼리 튜닝과 인덱스 설계 등 로우레벨 최적화에서 출발해, 필요할
                때에만 아키텍처를 확장하는 방식을 추구합니다.
              </p>
              <p className="text-gray-300 mb-6">
                보안성과 성능을 함께 고민하며, 작지만 단단한 구조에서 시작해
                필요한 순간에 확장하는 개발을 지향합니다.
              </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">
              © 2024 임채연 백엔드 개발자 포트폴리오. All rights reserved.
            </p>
